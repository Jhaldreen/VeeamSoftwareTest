...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'sync1'], 'latin1') == 'sync1'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'sync1'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'sync1'
